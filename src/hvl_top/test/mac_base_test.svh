...
function void mac_base_test_c::configure_test();
  ...
  foreach (env_cfg_h.reset_agent_cfgs[i]) begin
    env_cfg_h.reset_agent_cfgs[i] = mac_reset_agent_cfg_c::type_id::create($sformatf("reset_cfg[%0d]", i));
  ...
  foreach (env_cfg_h.axi_active_agent_cfgs[i]) begin
    env_cfg_h.axi_active_agent_cfgs[i] = axi_agent_cfg_c::type_id::create($sformatf("axi_active_cfg[%0d]", i));
  ...
  foreach (env_cfg_h.axi_passive_agent_cfgs[i]) begin
    env_cfg_h.axi_passive_agent_cfgs[i] = axi_agent_cfg_c::type_id::create($sformatf("axi_passive_cfg[%0d]", i));
  ...
  foreach (env_cfg_h.rs_active_agent_cfgs[i]) begin
    env_cfg_h.rs_active_agent_cfgs[i] = rs_agent_cfg_c::type_id::create($sformatf("rs_active_cfg[%0d]", i));
  ...
  foreach (env_cfg_h.rs_passive_agent_cfgs[i]) begin
    env_cfg_h.rs_passive_agent_cfgs[i] = rs_agent_cfg_c::type_id::create($sformatf("rs_passive_cfg[%0d]", i));
