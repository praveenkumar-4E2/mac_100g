class mac_tx_ref_model_c extends uvm_component;
  ...
  uvm_analysis_imp#(mac_m_tx_xtn_c,mac_tx_ref_model_c) m_tx_fifo;
  ...
  extern function new(
    ...
    extern function void write(mac_m_tx_xtn_c m_tx_xtn);
...
function void mac_tx_ref_model_c :: write(mac_m_tx_xtn_c m_tx_xtn);
    //TODO
endfunction
