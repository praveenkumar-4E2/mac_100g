class mac_top_env_c extends uvm_env;
    ...
    mac_wr_agt_top_c m_tx_agt_top_h;
    mac_rd_agt_top_c m_rx_agt_top_h;
    mac_sb_c           sb_h;
    mac_wr_ref_model_c tx_ref_model_h;
    mac_rd_ref_model_c rx_ref_model_h;
...
function void mac_top_env_c :: build_phase(
  ...
  m_tx_agt_top_h = mac_wr_agt_top_c::type_id::create("m_tx_agt_top_h",this);
  m_rx_agt_top_h = mac_rd_agt_top_c::type_id::create("m_rx_agt_top_h",this);
  sb_h           =           mac_sb_c::type_id::create("sb_h",this);
  tx_ref_model_h = mac_wr_ref_model_c::type_id::create("tx_ref_model_h",this);
  rx_ref_model_h = mac_rd_ref_model_c::type_id::create("rx_ref_model_h",this);
