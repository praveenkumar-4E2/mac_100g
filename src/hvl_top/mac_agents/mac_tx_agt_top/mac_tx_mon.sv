...
class mac_tx_monitor_c extends uvm_monitor;
  `uvm_component_utils(mac_tx_monitor_c)

  uvm_analysis_port #(mac_tx_item_c) analysis_port;
  mac_tx_item_c                      tx_item_h;

  extern function new(string name = "mac_tx_monitor_c", uvm_component parent = null);
 ...
 */
function mac_tx_monitor_c::new(string name = "mac_tx_monitor_c", uvm_component parent = null);
 ...
 */
function void mac_tx_monitor_c::build_phase(uvm_phase phase);
