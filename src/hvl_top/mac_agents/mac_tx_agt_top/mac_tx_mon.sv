 ...
 */
class mac_tx_mon_c extends uvm_monitor;
  `uvm_component_utils(mac_tx_mon_c)

  uvm_analysis_port #(mac_tx_xtn_c) item_collect_port;
  mac_tx_xtn_c                      tx_xtn_h;

  extern function new(
    string name = "mac_tx_mon_c",
 ...
 */
function void mac_tx_mon_c::build_phase(
  uvm_phase phase
);
  super.build_phase(phase);
  tx_xtn_h = mac_tx_xtn_c::type_id::create("tx_xtn_h");
endfunction
