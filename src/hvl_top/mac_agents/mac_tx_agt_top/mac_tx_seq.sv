 ...
 */
class mac_tx_seq_c extends uvm_sequence #(mac_tx_xtn_c);
  `uvm_object_utils(mac_tx_seq_c)

   mac_tx_xtn_c tx_xtn_h;

  extern function new(
    string name = "mac_tx_seq_c"
  );
  extern task body();
endclass
