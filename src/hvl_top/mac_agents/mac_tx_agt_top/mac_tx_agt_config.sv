 ...
 */
class mac_tx_agent_cfg_c extends uvm_object;
  `uvm_object_utils(mac_tx_agent_cfg_c)
  ...
  extern function new(string name = "mac_tx_agent_cfg_c");
endclass
 ...
 */
function mac_tx_agent_cfg_c::new(string name = "mac_tx_agent_cfg_c");
  super.new(name);
endfunction
